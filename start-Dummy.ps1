#Start-Transcript -Path C:\Windows\temp\xxLogNamexx.log -Append
  ...
  public static class Program
  {
    public static uint Launch(string process, string arguments = "")
    {
        ...
        out interactiveUserToken))
      {
        ...
        siInteractive.lpDesktop = @"Winsta0\Winlogon";
...
if ($Provmode -ne "false")
{
    ...
    while ($b -eq [IntPtr]::Zero)
    {
        ...
        #If (((gwmi Win32_computersystem).Username -eq $null) -and ($ConsoleToken -eq $false))
    	{
